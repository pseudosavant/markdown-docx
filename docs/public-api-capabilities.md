...
`markdown-docx` 1.0.0 pins `python-docx` 1.2.0. The executable probe is `tests/test_public_api_capabilities.py`.

| Capability | Public API in 1.2.0 | 1.0.0 behavior |
| --- | --- | --- |
